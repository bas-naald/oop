...
export default class InnerShipAfterMoon extends InnerShip {
  ...
  public override update(elapsed: number): void {
    ...
    if ((this.player.getPosX() > 650 || this.player.getPosX() + this.player.getWidth() > 650)
    && (this.player.getPosX() < 940 || this.player.getPosX() + this.player.getWidth() < 940)) {
  ...
  public override render(canvas: HTMLCanvasElement): void {
    ...
    CanvasRenderer.writeText(canvas, 'scrap: 20', 0, 130, 'left', 'arial', 40, 'black');
    CanvasRenderer.writeText(canvas, 'fix comminication', this.obj.getPosX() + 30, 80, 'left', 'arial', 20, 'black');
    CanvasRenderer.writeText(canvas, 'navigation fixed', this.maxX - 200, 600, 'left', 'arial', 20, 'yellow');
