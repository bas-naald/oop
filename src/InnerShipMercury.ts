...
export default class InnerShipMercury extends InnerShip {
  ...
  public override render(canvas: HTMLCanvasElement): void {
    ...
    CanvasRenderer.writeText(canvas, 'go to terminal and go to mercury', this.obj.getPosX() + 30, 80, 'left', 'arial', 20, 'black');
