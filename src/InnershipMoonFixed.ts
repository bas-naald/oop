...
export default class InnershipMoonFixed extends InnerShip {
  ...
  public override nextScene(): Scene | null {
    if (this.loadMercury) {
      return new Mars(this.maxX, this.maxX);
    }else{
      return null;
    }
  }
  ...
  public override render(canvas: HTMLCanvasElement): void {
    ...
    CanvasRenderer.writeText(canvas, 'return to mars!', this.obj.getPosX() + 30, 80, 'left', 'arial', 20, 'black');
