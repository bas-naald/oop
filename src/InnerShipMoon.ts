...
export default class InnerShipMoon extends InnerShip {
  ...
  public override render(canvas: HTMLCanvasElement): void {
    ...
    CanvasRenderer.writeText(canvas, 'go to terminal and choose moon', this.obj.getPosX() + 30, 80, 'left', 'arial', 20, 'black');
